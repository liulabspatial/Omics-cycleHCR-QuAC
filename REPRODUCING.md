...
## 3. Quick start (the 5-minute recipe)

End-to-end re-run of the two key reviewer-facing analyses (cell-clustering UMAP and the robustness sweep) from a fresh clone:

```bash
# 1. Install the analysis environment (one-time)
