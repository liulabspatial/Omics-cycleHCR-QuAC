def main():
    ...
    image_root = "/path/to/Step6_crop"          # <- change to your path
    cell_id_csv = "selected_cell_IDs.csv"        # <- change to your path
    output_root = "./QUAC_images_all_cells"      # <- change to your path
